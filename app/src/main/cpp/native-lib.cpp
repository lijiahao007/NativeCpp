...
extern "C" JNIEXPORT void JNICALL Java_com_lijiahao_nativecpp_NativeCppLibrary_initLogFile(JNIEnv *env, jclass clazz,
                                                         jstring log_dir) {
    // 转换Java字符串到C++字符串
...
Java_com_lijiahao_nativecpp_NativeCppLibrary_logNative(JNIEnv *env, jclass clazz, jstring msg) {
